    ...
    try {
        ...
        if (verEl) {
            ...
            verEl.innerHTML = `
                ...
                <div><a href="https://github.com/wknet1988/Gamediso" target="_blank" style="color:#888 !important; text-decoration:none; font-size:13px;">${githubSvg} ${t.github_label}</a></div>
            `;
        }
